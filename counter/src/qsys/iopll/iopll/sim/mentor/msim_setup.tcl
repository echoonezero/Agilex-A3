...
# ----------------------------------------
# If iopll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.1.1 125 win32 2025.09.28.14:05:29
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "iopll.iopll"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/altera_pro/25.1.1/quartus/"
}
...
append ELAB_OPTIONS [subst [iopll::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [iopll::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [iopll::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [iopll::normalize_path "$file"]
  set normalized_dest [iopll::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [iopll::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [iopll::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [iopll::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [iopll::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
